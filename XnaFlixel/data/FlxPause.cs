...
namespace XnaFlixel.data
{
    ...
    public class FlxPause
    {
        ...
        public FlxPause()
        {
			...
			_imgKeyX = FlxG.Game.Content.Load<Texture2D>("flixel/key_x");
			_imgKeyC = FlxG.Game.Content.Load<Texture2D>("flixel/key_c");
			_imgKeyMouse = FlxG.Game.Content.Load<Texture2D>("flixel/key_mouse");
			_imgKeysArrows = FlxG.Game.Content.Load<Texture2D>("flixel/keys_arrows");
			_imgKeyMinus = FlxG.Game.Content.Load<Texture2D>("flixel/key_minus");
			_imgKeyPlus = FlxG.Game.Content.Load<Texture2D>("flixel/key_plus");
			_imgKey0 = FlxG.Game.Content.Load<Texture2D>("flixel/key_0");
			_imgKey1 = FlxG.Game.Content.Load<Texture2D>("flixel/key_1");
